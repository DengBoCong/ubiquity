...
import com.dbc.ubiquity.Repository.MessageRepository;
...
public class MessageController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "id", value = "正文", required = true, dataType = "String", paramType = "query"),
